...
caseName            = 'pglib_opf_case1354_pegase_8regions';
...
centralizedCost    = 1332430.352227;%fvalac;     % set 0 to disable optimality gap plot
...
outPrefix = 'pglib_opf_case24464_goc_10regions';
...
params.gamma1 = 0.7;     % finite/fixed
params.gamma2 = 0.8;     % fixed only
...
title(sprintf('%s', outPrefix), 'Interpreter','none', 'FontSize', 22, 'FontWeight', 'bold');
