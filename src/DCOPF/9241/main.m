...
caseName            = 'pglib_opf_case9241_pegase_18regions';  
...
rho                = 1e0;      % base ADMM penalty (same as your main setup)
residualThreshold  = 1e-3;     % stopping criterion on max normalized residual
maxIterations      = 100000;   % cap on ADMM iterations
holds              = 4e6;      % upper bound for adaptive rho
...
w1_primal = 100.0;
w2_primal = 0.001;   % you can tune this; w2=0 recovers classical copy
...
out_dual_finite = DistDCOPF(partitionedDataFile, rho, residualThreshold, ...
                            maxIterations, 6144174.336633016, holds, ....
                            'dual', 'finite', w1_primal, 0.0);% 6068737.6175  6044174.336633016
