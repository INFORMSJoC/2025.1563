...
caseName            = 'pglib_opf_case24464_goc_10regions';  
...
holds              = 2e6;      % upper bound for adaptive rho
...
centralizedCost    = 2538174.812383832;%fvaldc;   % <-- EDIT THIS to your centralized cost
